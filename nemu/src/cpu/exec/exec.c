...
make_group(gp5,
  ...
  /* 0x0f 0x01 — outer IDEX(gp7_E, gp7) already decoded ModR/M; inner must be EX only. */
make_group(gp7,
...
opcode_entry opcode_table [512] = {
  ...
  /* 0xa8 */	IDEXW(I2a, test, 1), IDEX(I2a, test), EX(stosb), EX(stos),
  ...
  /* 0xf8 */	EX(clc), EX(stc), EMPTY, EMPTY,
